...
void loop() 
{
  ...
  int randomVelocity = random(25, 127);
  ...
  noteOn(0, randomNote, randomVelocity);   // Channel 0, middle C, normal velocity
  MidiUSB.flush();
  delay(randomDelay);
  Serial.println("Sending note off");
  noteOff(0, randomNote, randomVelocity);  // Channel 0, middle C, normal velocity
  MidiUSB.flush();
  delay(randomDelay);

  controlChange(0, 10, randomVabrato); // Set the value of controller 10 on channel 0 to 65
